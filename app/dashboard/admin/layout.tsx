      ...
      <div className="flex flex-1 flex-col">
        <header className="sticky top-0 z-10 flex flex-col gap-4 border-b border-slate-200 bg-white/90 px-6 py-5 backdrop-blur lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="text-2xl font-semibold text-slate-900">Dealer Command Center</h1>
            <p className="text-sm text-slate-500">Monitor onboarding and manage every dealership touch-point.</p>
          </div>
