...
export default function AssociateBusinessOverviewPage() {
    ...
    <div className="space-y-8">
      <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="text-2xl font-semibold text-slate-900">My Business Overview</h1>
          <p className="text-sm text-slate-500">Your personal business performance and metrics.</p>
        </div>
        <button
          onClick={refresh}
